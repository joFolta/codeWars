/* 
https://www.codewars.com/kata/spanish-conjugator/discuss/javascript
...
function conjugate(verb) {
  ...
  function whichSuffix(verbInput) {
    return verb.slice(-2);
  };
  
  const verbRoot = verb.slice(0,-2);
  
  if (whichSuffix(verb) === 'ar') {
    return {
        [verb]: [
          verbRoot+'o',
          verbRoot+"as",
